    ...
    <header class="header">
        <div class="header__inner inner">
            ...
            <ul class="header__inner__icons">
                ...
                <li class="header__inner__icons__icon"><a href="{{ route('member.create') }}"><button class="btn icon-btn" title="ユーザー情報編集"><i class="fas fa-user-cog"></i></button></a></li>
                <li class="header__inner__icons__icon"><a href=""><button class="btn icon-btn" title="ログイン画面へ"><i class="fas fa-user"></i></button></a></li>
            </ul>
            <div class="header__inner__menus">
                ...
                <ul class="header__inner__menus__nav-lists">
                    ...
                    <li class="header__inner__menus__nav-lists__nav-list"><a href="{{ route('member.create') }}" title="ユーザー情報編集">USER</a></li>
                    <li class="header__inner__menus__nav-lists__nav-list"><a href="" title="ログイン画面へ">LOGIN</a></li>
                </ul>
            </div>
        </div>
    </header>
